      ...
      $("article").each(function(i, element) {
        ...
        let img = $(this)
          ...
          if (titlesArray.indexOf(results.title) === -1) {
            ...
            titlesArray.push(results.title); // so save this title into titlesArray in case the article appears again in this scrape
            // Now, make sure that this article hasn't previously been saved into the DB
            db.Article.count({ title: results.title}, function (err,dupeCheck){
              if (dupeCheck === 0) {
